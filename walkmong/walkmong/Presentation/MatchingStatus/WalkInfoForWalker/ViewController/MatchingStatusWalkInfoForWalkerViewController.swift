//
//  MatchingStatusWalkInfoForWalkerViewController.swift
//  walkmong
//
...
final class MatchingStatusWalkInfoForWalkerViewController: UIViewController, MatchingStatusWalkInfoForWalkerViewDelegate {
...
//                }
    ...
    // MARK: - Properties
    private let matchingStatusWalkInfoForWalkerView = MatchingStatusWalkInfoForWalkerView()
    ...
    private func setupView() {
        ...
        matchingStatusWalkInfoForWalkerView.snp.makeConstraints { make in
            make.top.equalTo(view.safeAreaLayoutGuide.snp.top).offset(52)
            make.leading.trailing.bottom.equalToSuperview()
        }
        matchingStatusWalkInfoForWalkerView.delegate = self
    }
    ...
    private func loadData() {
        ...
        matchingStatusWalkInfoForWalkerView.updateDogProfile(with: dogProfileData)
    }
