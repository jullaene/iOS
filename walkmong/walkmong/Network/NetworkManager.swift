...
class NetworkManager {
    ...
    private func mockBoardList() -> [MatchingData] {
        return [
            ...
            MatchingData(boardId: 1, startTime: "12:34", endTime: "12:50", matchingYn: "N", dogName: "Dog1", dogProfile: "https://www.fitpetmall.com/wp-content/uploads/2022/11/shutterstock_196467692-1024x819.jpg", dogGender: "FEMALE", breed: "말티즈", weight: 2, dogSize: "SMALL", content: "테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.", dongAddress: "노원구 공릉동", distance: 1000, createdAt: "2024-11-11 14:30:00.000000"),
            MatchingData(boardId: 1, startTime: "12:34", endTime: "12:50", matchingYn: "Y", dogName: "Dog1", dogProfile: "https://www.fitpetmall.com/wp-content/uploads/2022/11/shutterstock_196467692-1024x819.jpg", dogGender: "FEMALE", breed: "말티즈", weight: 2, dogSize: "SMALL", content: "테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.", dongAddress: "노원구 공릉동", distance: 1000, createdAt: "2024-11-11 14:30:00.000000"),
            MatchingData(boardId: 1, startTime: "12:34", endTime: "12:50", matchingYn: "N", dogName: "Dog1", dogProfile: "https://www.fitpetmall.com/wp-content/uploads/2022/11/shutterstock_196467692-1024x819.jpg", dogGender: "FEMALE", breed: "말티즈", weight: 2, dogSize: "SMALL", content: "테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.", dongAddress: "노원구 공릉동", distance: 1000, createdAt: "2024-11-11 14:30:00.000000"),
            MatchingData(boardId: 1, startTime: "12:34", endTime: "12:50", matchingYn: "Y", dogName: "Dog1", dogProfile: "https://www.fitpetmall.com/wp-content/uploads/2022/11/shutterstock_196467692-1024x819.jpg", dogGender: "FEMALE", breed: "말티즈", weight: 2, dogSize: "SMALL", content: "테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.", dongAddress: "노원구 공릉동", distance: 1000, createdAt: "2024-11-11 14:30:00.000000"),
            MatchingData(boardId: 1, startTime: "12:34", endTime: "12:50", matchingYn: "N", dogName: "Dog1", dogProfile: "https://www.fitpetmall.com/wp-content/uploads/2022/11/shutterstock_196467692-1024x819.jpg", dogGender: "FEMALE", breed: "말티즈", weight: 2, dogSize: "SMALL", content: "테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.테스트메시지가 두 줄은 넘어야 확인할수 있죠.", dongAddress: "노원구 공릉동", distance: 1000, createdAt: "2024-11-11 14:30:00.000000")
    ...
    private func mockBoardDetail() -> BoardDetail {
        return BoardDetail(dogId: 1, dogName: "봄별이", dogProfile: "https://www.fitpetmall.com/wp-content/uploads/2022/11/shutterstock_196467692-1024x819.jpg", dogGender: "FEMALE", dogAge: 4, breed: "말티즈", weight: 4, dogSize: "SMALL", dongAddress: "노원구 공릉동", distance: 1000, date: "2024-10-25", startTime: "12:34", endTime: "12:50", locationNegotiationYn: "Y", suppliesProvidedYn: "Y", preMeetAvailableYn: "Y", walkNote: "이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.", walkRequest: "이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.", additionalRequest: "이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.", ownerName: "김철수", ownerAge: 27, ownerGender: "MALE", ownerProfile: "profileExample", ownerRate: 4.0)
    }
