...
class NetworkManager {
    ...
    private func mockBoardDetail() -> BoardDetail {
        return BoardDetail(dogId: 1, dogName: "봄별이", dogProfile: "puppyImage01", dogGender: "FEMALE", dogAge: 4, breed: "말티즈", weight: 4, dogSize: "SMALL", dongAddress: "동네 1", distance: 1000, date: "2024-10-25", startTime: "12:34", endTime: "56:78", locationNegotiationYn: "Y", suppliesProvidedYn: "Y", preMeetAvailableYn: "Y", walkNote: "이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.", walkRequest: "이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.", additionalRequest: "이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.이건 세 줄 넘어야 될 거 같아요. 복붙을 많이 해볼게요.", ownerName: "김철수", ownerAge: 27, ownerGender: "MALE", ownerProfile: "profileExample", ownerRate: 4.0)
    }
